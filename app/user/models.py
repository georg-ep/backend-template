...
class Address(models.Model):
    ...
    city = models.CharField(default="", max_length=64, verbose_name=_("City"))
    street = models.CharField(default="", max_length=64, verbose_name=_("Street"))
    postal_code = models.CharField(
        default="", max_length=10, verbose_name=_("Postal code")
    )
    state = models.CharField(default="", max_length=64, verbose_name=_("State"))
    country = models.CharField(default="", max_length=64, verbose_name=_("Country"))
